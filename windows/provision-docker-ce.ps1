...
# see https://github.com/docker/docker-ce/releases/tag/v19.03.7
# see https://github.com/rgl/docker-ce-windows-binaries-vagrant/releases/tag/v19.03.7

# download install the docker binaries.
$archiveVersion = '19.03.7'
...
$archiveHash = 'b84e6c26da4dab7c745a9674e721317fec848cfec14fae2b11d3579b5b1845c8'
