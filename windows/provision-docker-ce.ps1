...
# see https://github.com/moby/moby/releases/tag/v23.0.2
# see https://github.com/rgl/docker-ce-windows-binaries-vagrant/releases/tag/v23.0.2

# download install the docker binaries.
# renovate: datasource=github-releases depName=rgl/docker-ce-windows-binaries-vagrant
$archiveVersion = '23.0.2'
