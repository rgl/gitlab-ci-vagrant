...
# see https://github.com/moby/moby/releases/tag/v28.2.2
# see https://github.com/rgl/docker-ce-windows-binaries-vagrant/releases/tag/v28.2.2

# download install the docker binaries.
# renovate: datasource=github-releases depName=rgl/docker-ce-windows-binaries-vagrant
$archiveVersion = '28.2.2'
