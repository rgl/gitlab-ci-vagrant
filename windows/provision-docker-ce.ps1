...
# see https://github.com/moby/moby/releases/tag/v28.1.1
# see https://github.com/rgl/docker-ce-windows-binaries-vagrant/releases/tag/v28.1.1

# download install the docker binaries.
# renovate: datasource=github-releases depName=rgl/docker-ce-windows-binaries-vagrant
$archiveVersion = '28.1.1'
