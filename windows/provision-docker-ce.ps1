...
# see https://github.com/moby/moby/releases/tag/v23.0.5
# see https://github.com/rgl/docker-ce-windows-binaries-vagrant/releases/tag/v23.0.5

# download install the docker binaries.
# renovate: datasource=github-releases depName=rgl/docker-ce-windows-binaries-vagrant
$archiveVersion = '23.0.5'
