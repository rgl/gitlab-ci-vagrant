...
# see https://github.com/moby/moby/releases/tag/v25.0.3
# see https://github.com/rgl/docker-ce-windows-binaries-vagrant/releases/tag/v25.0.3

# download install the docker binaries.
# renovate: datasource=github-releases depName=rgl/docker-ce-windows-binaries-vagrant
$archiveVersion = '25.0.3'
